...
export const screenResume = async (resumeText: string, jd: any) => {
...
export const generateQuestions = async (jd: any, screeningResult: any) => {
...
export const evaluateInterview = async (jd: any, transcript: any[]) => {
...
export const suggestJobSkills = async (title: string) => {
